...
$(ObjDir)/conv3x3.cpp_pre.cpp.tb.o : conv3x3.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling conv3x3.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/main_func.cpp_pre.cpp.tb.o : main_func.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling main_func.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
